...
app.post('/api/single-file', upload.single('file'),
        (req, res) => {
...
app.post('/api/Quality/Department/:depart/QRCI/:id', jsonParser, function (request, response) {
...
app.post("/api/Maitanence/workList", jsonParser, function (request, response) {
  ...
  app.post("/api/Maitanence/workListPeriod", jsonParser, function (request, response) {
    if(!request.body) return response.sendStatus(400);
  ...
  app.post("/api/Maitanence/workListPeriodReport", jsonParser, function (request, response) {
    if(!request.body) return response.sendStatus(400);
